...
const KategoriPage: React.FC = () => {
  ...
  const handleUpdate = () => {
    ...
    fetch(`https://backend-sisteminformasi-production.up.railway.app/kategori/${editId}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': localStorage.getItem('token') ? `Bearer ${localStorage.getItem('token')}` : ''
  ...
  const handleDelete = (id: string) => {
    ...
    fetch(`https://backend-sisteminformasi-production.up.railway.app/kategori/${id}`, {
      method: 'DELETE',
      headers: {
        'Authorization': localStorage.getItem('token') ? `Bearer ${localStorage.getItem('token')}` : ''
      }
